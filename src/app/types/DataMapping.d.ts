...
export interface DataMapping {
  /**
   * The unique identifier (handle) of the Data Mapping object
   */
  "@id"?: string;
  /**
   * The type of the object, in this case ods:DataMapping
   */
  ...
  /**
   * Name of the Mapping as provided by the user
   */
  "schema:name"?: string;
  /**
   * Description of the Mapping as provided by the user
   */
  "schema:description"?: string;
  /**
   * Timestamp of creation. Internally generated, follows the ISO Date Time Format yyyy-MM-dd'T'HH:mm:ss.SSSXXX
   */
  ...
  /**
   * A mapping object setting default values for ods terms. These default mappings will be set for each record in the dataset. Key is the ods term, value the default value to use
   */
  "ods:hasDefaultMapping"?: DefaultMapping[];
  /**
   * Setting an explicit mapping for an ods term to a term from the incoming dataset. Key is the ods term, value the incoming data standard term
   */
  "ods:hasTermMapping"?: TermMapping[];
  /**
   * The data standard that is being mapped from
   */
  "ods:mappingDataStandard": "DwC" | "ABCD" | "ABCDEFG";
  "ods:hasTombstoneMetadata"?: TombstoneMetadata;
}
/**
 * The creator of the Data Mapping, generally this will also be the only person able to change the data mapping
 */
